...
<div class="container cont">
    ...
    <div>
        <center>
            <div class=""><br>
                <form action="{{ route('idiomas.update', $idiomas) }}" method="POST" class="form shadow p-3 mb-5 rounded ">
                    @csrf
                    @method('PUT')
                    <h1>FORMULARIO DE IDIOMAS</h1>
                    <div><br><br>
                        <label for=" descripcion" class="form-label">Descripcion</label>
                        <input type="text" class="form-control" id="descripcion" name="descripcion" value="{{ old('descripcion', $idiomas->descripcion) }}">
                        @error('descripcion')
