...
<div class="container cont">
    ...
    <div>
        <center>
            <div class=""><br>
                <form action="{{ route('libros.store') }}" method="POST" class="form shadow p-3  mb-5 rounded " style="background: #A37F6F">
                    @csrf
                    ...
                    <div><br><br>
                        ...
                        <input type="date" class="form-control" id="fecha_publicacion" name="fecha_publicacion" value="{{ old('fecha_publicacion') }}">
                    ...
                    <div><br><br>
                        ...
                        <select name="cod_idioma" id="idioma" class="form-select" value="{{ old('cod_idioma') }}">
                            ...
                            <option value="{{ $idiomas->cod_idioma }}">{{ $idiomas->descripcion }}</option>
                            @endforeach
                        </select>
                        @error('cod_idioma')
                    ...
                    <div>
                        ...
                        <input type="checkbox" class="" name="categorias[]" value="{{ $key }}" {{ (is_array(old('categorias')) && in_array($key, old('categorias'))) ? 'checked' : '' }}>
                        {{ $value }}
                        @endforeach
                        @error('categoria')
                    ...
                    <div>
                        ...
                        <input type="checkbox" class="" name="autores[]" value="{{ $key }}" {{ (is_array(old('autores')) && in_array($key, old('autores'))) ? 'checked' : '' }}>
                        {{ $value }}
                        @endforeach
                        @error('categoria')
