...
<div class="container cont">
    ...
    <div><br>
        ...
        <div><br>
            <div align="right">
                <a class="btn btn-dark" href="{{ route('sexos.create') }}">Agregar Sexo</a>
            </div><br>
            @if (sizeof($sexo) > 0)
            <table class="table table-secondary">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $sexo->descripcion }}</td>
                        <td class="text-center">
                            <div class="row">
                                <div class="col m-6">
                                    <a href="{{ route('sexos.edit', $sexo) }}" class="btn btn-secondary">Editar</a>
                                </div>
                                <div class="col m-6">
                                    <form action="{{ route('sexos.destroy', $sexo) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
